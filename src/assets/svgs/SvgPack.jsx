...
const GPS = () => {
  ...
  <g filter="url(#filter0_d_1_258)">
    <circle cx="24" cy="20" r="20" fill="white" fillOpacity="0.3"/>
    <circle cx="24" cy="20" r="20" fill="#6E707A" fillOpacity="0.3"/>
  ...
  <defs>
    <filter id="filter0_d_1_258" x="0" y="0" width="48" height="48" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
